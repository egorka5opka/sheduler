...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.flowerbed.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.flowerbed.setDragEnabled(True)
        self.flowerbed.setSelectionMode(QtWidgets.QAbstractItemView.NoSelection)
        self.flowerbed.setObjectName("flowerbed")
        self.flowerbed.setColumnCount(0)
        self.flowerbed.setRowCount(0)
        self.flowerbed.horizontalHeader().setVisible(False)
        self.flowerbed.horizontalHeader().setMinimumSectionSize(35)
        self.flowerbed.verticalHeader().setVisible(False)
